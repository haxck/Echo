...
export default function Letter() {
  ...
  return (
    <>
      <div className="flex flex-col h-screen items-center justify-center font-xiaolai ">
        <div className="max-w-sm rounded-lg shadow-lg p-4  bg-[#d6bca7e7] ">
          <div className="letter-header text-center font-bold text-2xl">

          </div>
          <div className="letter-content mt-4  ">
            <div className="whitespace-pre-wrap flex flex-col gap-2 tracking-wide leading-7" dangerouslySetInnerHTML={{ __html: datas.content }}>
